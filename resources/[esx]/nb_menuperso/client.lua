		...
		ESX.UI.Menu.Open(
			...
			function(data, menu)
				...
				if playergroup == 'mod' then
					...
					--table.insert(elements, {label = 'Se give de l\'argent',						value = 'menuperso_modo_give_money'})
					...
					--table.insert(elements, {label = 'Soigner une personne',					value = 'menuperso_modo_heal_player'})
				...
				if data.current.value == 'menuperso_moi' then
					...
					--table.insert(elements, {label = 'Accessoire',             					value = 'menuperso_moi_Accessory'})
					--table.insert(elements, {label = 'Gestion animal',             					value = 'menuperso_moi_Animal'})
					...
					ESX.UI.Menu.Open(
						...
						function(data2, menu2)
							...
							if data2.current.value == 'menuperso_moi_Accessory' then
								openAccessory()
							end				
								...
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Salute',
									{
										...
										elements = {
											...
											{label = 'Chut',  value = 'menuperso_actions_Salute_chut'},
											{label = 'Me parle pas !',  value = 'menuperso_actions_Salute_parlepas'},
											{label = 'Lever son pouce',  value = 'menuperso_actions_Salute_pouce'},
											{label = 'Saluer public',  value = 'menuperso_actions_Salute_saluerpu'},
										},
									},
									function(data3, menu3)
										...
										if data3.current.value == 'menuperso_actions_Salute_chut' then
											animsAction({ lib = "anim@mp_player_intuppershush", anim = "idle_a_fp" })
										end	

										if data3.current.value == 'menuperso_actions_Salute_parlepas' then
											animsAction({ lib = "mini@prostitutestalk", anim = "street_argue_f_a" })
										end	

										if data3.current.value == 'menuperso_actions_Salute_pouce' then
											animsAction({ lib = "anim@mp_player_intincarthumbs_uplow@ds@", anim = "enter" })
										end	

										if data3.current.value == 'menuperso_actions_Salute_saluerpu' then
											animsAction({ lib = "anim@mp_player_intcelebrationpaired@f_f_sarcastic", anim = "sarcastic_right" })
										end											
							...
							if data2.current.value == 'menuperso_actions_Humor' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Humor',
									{
										...
										align    = 'top-left',
										elements = {
											--{label = 'Fumer une clope',     value = 'menuperso_actions_Humor_fumeruneclope'},
											--{label = 'Fumer un join',     value = 'menuperso_actions_Humor_fumerunjoin'},
											{label = 'Arrestation',     value = 'menuperso_actions_Humor_arrestation'},
										    {label = 'Couché sur le dos',  value = 'menuperso_actions_Humor_couchedos'},
											{label = 'Couché sur le ventre',  value = 'menuperso_actions_Humor_coucheventre'},
											{label = 'Blessé assis',  value = 'menuperso_actions_Humor_bassis'},
											{label = 'Blessé couché',  value = 'menuperso_actions_Humor_bcouche'},
											{label = 'Féliciter',  value = 'menuperso_actions_Humor_feliciter'},
											{label = 'Super',     value = 'menuperso_actions_Humor_super'},
											{label = 'Super 2',     value = 'menuperso_actions_Humor_supers'},
											...
											{label = 'Double Fuck',  value = 'menuperso_actions_Humor_doightdhonneur'},
											{label = 'Fuck',  value = 'menuperso_actions_Humor_fuckd'},
											...
											{label = 'Siffler',  value = 'menuperso_actions_Humor_siffler'},
											{label = 'Gagner',  value = 'menuperso_actions_Humor_gagner'},
											{label = 'Perdu',  value = 'menuperso_actions_Humor_perdu'},
											{label = 'Crotte de nez',  value = 'menuperso_actions_Humor_crotte'},
											{label = 'Filmer avec son telephone',  value = 'menuperso_actions_Humor_filmertel'},
										},
									},
									function(data3, menu3)
									
										if data3.current.value == 'menuperso_actions_Humor_fumeruneclope' then
											animsActionScenario({ anim = "WORLD_HUMAN_SMOKING" })
										end

										if data3.current.value == 'menuperso_actions_Humor_fumerunjoin' then
											animsActionScenario({ anim = "WORLD_HUMAN_SMOKING_POT" })
										end	

										if data3.current.value == 'menuperso_actions_Humor_arrestation' then
											animsAction({ lib = "random@arrests@busted", anim = "idle_c" })
										end										
									
										if data3.current.value == 'menuperso_actions_Humor_couchedos' then
											animsActionScenario({anim = "WORLD_HUMAN_SUNBATHE_BACK" })
										end									

										if data3.current.value == 'menuperso_actions_Humor_coucheventre' then
											animsActionScenario({anim = "WORLD_HUMAN_SUNBATHE" })
										end	

										if data3.current.value == 'menuperso_actions_Humor_bassis' then
											animsAction({ lib = "anim@heists@prison_heistig_5_p1_rashkovsky_idle", anim = "idle_180" })
										end	

										if data3.current.value == 'menuperso_actions_Humor_bcouche' then
											animsAction({ lib = "combat@damage@writhe", anim = "writhe_loop" })
										end											
										...
										if data3.current.value == 'menuperso_actions_Humor_supers' then
											animsAction({ lib = "mp_action", anim = "thanks_male_06" })
										end										
										...
										if data3.current.value == 'menuperso_actions_Humor_fuckd' then
											animsAction({ lib = "anim@mp_player_intselfiethe_bird", anim = "exit" })
										end
										...
										if data3.current.value == 'menuperso_actions_Humor_siffler' then
											animsAction({ lib = "rcmnigel1c", anim = "hailing_whistle_waive_a" })
										end	

										if data3.current.value == 'menuperso_actions_Humor_gagner' then
											animsAction({ lib = "mini@golfclubhouse", anim = "clubhouse_leave_win_plyr" })
										end	

										if data3.current.value == 'menuperso_actions_Humor_perdu' then
											animsAction({ lib = "mini@golfclubhouse", anim = "clubhouse_leave_lose_plyr" })
										end	

										if data3.current.value == 'menuperso_actions_Humor_crotte' then
											animsAction({ lib = "anim@mp_player_intcelebrationmale@nose_pick", anim = "nose_pick" })
										end											

										if data3.current.value == 'menuperso_actions_Humor_filmertel' then
							...
							if data2.current.value == 'menuperso_actions_Travail' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Travail',
									{
										...
										align    = 'top-left',
										elements = {
										    {label = 'Lire des notes',  value = 'menuperso_actions_Travail_lirenote'},
											{label = 'Prendre des notes',  value = 'menuperso_actions_Travail_prendrenote'},
											...
											{label = 'Faire la circulation',  value = 'menuperso_actions_Travail_circulation'},
											{label = 'Inspecter',  value = 'menuperso_actions_Travail_inspecter'},
										},
									},
									function(data3, menu3)

										if data3.current.value == 'menuperso_actions_Travail_lirenote' then
											animsActionScenario({anim = "WORLD_HUMAN_CLIPBOARD" })
										end										
									
										if data3.current.value == 'menuperso_actions_Travail_prendrenote' then
										...
										if data3.current.value == 'menuperso_actions_Travail_circulation' then
							...
							if data2.current.value == 'menuperso_actions_Festives' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Festives',
									{
										...
										align    = 'top-left',
										elements = {
											{label = 'Danse 1',  value = 'menuperso_actions_Festives_danser'},
											{label = 'Danse 2',  value = 'menuperso_actions_Festives_danse'},
											{label = 'Danse 3',  value = 'menuperso_actions_Festives_dans'},
											{label = 'Danse chelou',  value = 'menuperso_actions_Festives_dansee'},
									...
									function(data3, menu3)
										...
										if data3.current.value == 'menuperso_actions_Festives_danse' then
											animsAction({ lib = "rcmnigel1bnmt_1b", anim = "dance_loop_tyler" })
										end										
										
										if data3.current.value == 'menuperso_actions_Festives_dans' then
											animsAction({ lib = "rcmnigel1bnmt_1b", anim = "dance_intro_tyler" })
										end		

										if data3.current.value == 'menuperso_actions_Festives_dansee' then
											animsAction({ lib = "anim@mp_player_intupperair_synth", anim = "idle_a_fp" })
										end											
							...
							if data2.current.value == 'menuperso_actions_Pegi' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Pegi',
									{
										...
										align    = 'top-left',
										elements = {
										    {label = 'Air Shagging',  value = 'menuperso_actions_Pegi_airshagging'},
											{label = 'Se gratter les couilles',     value = 'menuperso_actions_Others_segratterlesc'},
											{label = 'Homme se faire su*** en voiture',  value = 'menuperso_actions_Pegi_hommesefairesucer'},
											{label = 'Femme faire une gaterie en voiture',  value = 'menuperso_actions_Pegi_femmefaireunegaterie'},
											{label = 'Homme bais** en voiture',  value = 'menuperso_actions_Pegi_homme'},
											{label = 'Femme bais** en voiture',  value = 'menuperso_actions_Pegi_femme'},
											{label = 'Faire du charme',  value = 'menuperso_actions_Pegi_charme'},
											{label = 'Montrer sa poitrine',  value = 'menuperso_actions_Pegi_poitrine'},
											{label = 'Strip Tease 1',  value = 'menuperso_actions_Pegi_strip'},
											{label = 'Strip Tease 2',  value = 'menuperso_actions_Pegi_tease'},
											{label = 'Stip Tease au sol',  value = 'menuperso_actions_Pegi_sol'},
										},
									},
									function(data3, menu3)

										if data3.current.value == 'menuperso_actions_Pegi_airshagging' then
								...
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Others',
									{
										...
										elements = {
											...
											{label = 'Ecouter à une porte',     value = 'menuperso_actions_Others_ecouterporte'},
											{label = 'Prendre un selfie',     value = 'menuperso_actions_Others_prendreunselfie'},
											{label = 'BBQ',     value = 'menuperso_actions_Others_bbq'},
											{label = 'Paparazzi',     value = 'menuperso_actions_Others_papara'},
										},
									},
									function(data3, menu3)
										...
										if data3.current.value == 'menuperso_actions_Others_ecouterporte' then
										...
										if data3.current.value == 'menuperso_actions_Others_bbq' then
											animsActionScenario({ anim = "PROP_HUMAN_BBQ" })
										end		

										if data3.current.value == 'menuperso_actions_Others_papara' then
					...
					ESX.UI.Menu.Open(
						...
						function(data2, menu2)
							...
							if data2.current.value == 'menuperso_gpsrapide_poleemploi' then
								...
								ESX.ShowNotification("~h~Destination ajouté au GPS !")
							end
...
function admin_tp_toplayer()
	...
	Notify("~h~~b~Entrez l'ID du joueur...")
	inputgoto = 1
end
...
function admin_no_clip()
  ...
  if noclip then -- activé
	...
	Notify("~h~Noclip ~g~activé")
  else -- désactivé
    SetEntityInvincible(ped, false)
    SetEntityVisible(ped, true, false)
	Notify("~h~Noclip ~r~désactivé")
  end
end
...
function admin_godmode()
  ...
  if godmode then -- activé
		SetEntityInvincible(ped, true)
		Notify("~h~Mode invincible ~g~activé")
	else
		SetEntityInvincible(ped, false)
		Notify("~h~Mode invincible ~r~désactivé")
  end
end
-- FIN GOD MODE
...
function admin_mode_fantome()
  ...
  if invisible then -- activé
		SetEntityVisible(ped, false, false)
		Notify("~h~Mode fantôme ~g~activé")
	else
		SetEntityVisible(ped, true, false)
		Notify("~h~Mode fantôme ~r~désactivé")
  end
end
-- FIN INVISIBLE
...
function admin_vehicle_spawn()
	DisplayOnscreenKeyboard(true, "FMMC_KEY_TIP8", "", "", "", "", "", 120)
	Notify("~h~~b~Entrez le nom du véhicule...")
	inputvehicle = 1
end
	...
	while true do
		...
		local vehicleidd = GetOnscreenKeyboardResult()
				...
				Citizen.CreateThread(function()
					...
					Notify("~h~Véhicule livré, bonne route")
				end)
...
function admin_give_money()
	DisplayOnscreenKeyboard(true, "FMMC_KEY_TIP8", "", "", "", "", "", 120)
	Notify("~h~~b~Entrez le montant à vous octroyer...")
	inputmoney = 1
end
...
function modo_showname()
	if showname then
		...
		Notify("~h~Ouvrir/Fermer le menu pause pour afficher les noms")
		showname = true
	end
end
	...
	ESX.TriggerServerCallback('NB:getUsergroup', function(group)
		...
		if playergroup == 'admin' or playergroup == 'superadmin' or playergroup == 'owner' then
			...
			if DoesBlipExist(WaypointHandle) then
				...
				Notify("~h~Téléporté sur le marqueur !")
			else
				Notify("~h~Pas de marqueur sur la carte !")
			end
		end
...
function openIdentity()
	...
	TriggerEvent('NB:openMeIdentity')
end
...
function animsAction(animObj)
	if (IsInVehicle()) then
		local source = GetPlayerServerId();
		ESX.ShowNotification("~h~Sortez de votre véhicule pour faire cela !")
	else
		Citizen.CreateThread(function()
